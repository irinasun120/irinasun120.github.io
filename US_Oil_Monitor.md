...
One key challenge we faced was making the project both technically functional and narratively clear. Energy data can be difficult to interpret because supply, crude oil prices, gasoline prices, and geopolitical events are connected through multiple channels. To address this, we simplified the logic into a clear chain: geopolitical or conflict event → WTI crude oil price movement → potential impact on gasoline prices for U.S. consumers. This helped us frame our research questions more precisely: how much does conflict intensity in oil-producing countries affect WTI prices, how much does WTI affect U.S. gasoline prices, and how long does this transmission take?

## What I Learned

This project helped me better understand how computational tools can be used to communicate complex policy and market issues. Beyond coding, I learned the importance of building data products that are interpretable, visually clear, and useful for decision-making. The final app demonstrates my ability to combine data engineering, visualization, policy analysis, and product thinking in one applied project.
